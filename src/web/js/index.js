...
function registInSite() {
    if (new jj('#user_email').jjVal() == '' && new jj('#user_mobile').jjVal() == '') {//====== EDITED BY RASHIDI ======
        $("#registMessagePanel").html("ایمیل یا شماره موبایل نباید تهی باشد.");
        return false;
    }
    ...
    if (new jj('#user_pass').jjVal() == '') {
        $("#registMessagePanel").html("رمز عبور نباید تهی باشد.");
        return false;
    }
    ...
    if (new jj('#user_password_hint').jjVal() == '') {
        $("#registMessagePanel").html("لطفا یادآور گذروازه خود را وارد کنید.");
        return false;
    }
