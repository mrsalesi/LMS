var cmsContent = {
    ...
    f_tags: "content_tags",
    loadForm: function () {
        if ($("#swModiriatAzmonForm").html() == '') {
            $("#swModiriatAzmonForm").load("formCms/content.html", null, function () {
    ...
    m_refresh: function (containerId, sortField, tableHeight) {
        ...
        param += "&panel=" + (containerId == null ? "swModiriatAzmonTbl" : containerId);
    ...
    m_show_form: function () {
        $('#swModiriatAzmonTbl').hide();
        $('#swModiriatAzmonForm').show();
    ...
    m_show_tbl: function () {
        $('#swModiriatAzmonTbl').show();
        $('#swModiriatAzmonForm').hide();
        if ($('#swModiriatAzmonTbl').html() == "") {
            cmsContent.m_refresh();
        }
        cmsContent.tabSizeTbl();
    },
    m_insert: function () {
        ...
        if (valid == "") {
            ...
            param += "&" + new jj('#swModiriatAzmonForm').jjSerial();
            jj(param).jjAjax2(false);
            cmsContent.m_show_tbl();
            cmsContent.m_clean();
        } else {
...
//        alert(id+"&&&&&"+langId);
    ...
    //<============ BY RASHIDI ========    
    tabSizeTbl: function () {
        $('#swModiriatAzmon').css('height', 520);
    },
    tabSizeForm: function () {
        $('#swModiriatAzmon').css('height', 378);
    }
